from django.forms import ModelForm, CharField, TextInput, IntegerField, NumberInput, ModelChoiceField
...
class QuoteForm(ModelForm):
    tags = CharField(min_length=3, max_length=25, required=True, widget=TextInput())
